...
class CategoryTestCase(TestCase):
    ...
    def test_get_category(self,get_species_data, get_category_data):
        get_species_data.return_value = [{"species": "tigerFish","genus":"animalia","type": {},"kingdom":"Kingdom","image": "images/placeholder.png"}]
        get_category_data.return_value = []
        result = category.get_category('0', {})
        self.assertEqual([{"name": "tigerFish","genus":"animalia","type": {},"kingdom":"Kingdom","image": "images/placeholder.png"}], result)
