...
from .core.services import render_home, render_category, get_json, raise_exception,render_experts, find_species_experts, render_report, find_auto_complete_species, get_visual_report, get_visual_chart, about_us
...
@app.route('/visual/<path:filename>')
def visual_chart(filename):
    return get_visual_chart(filename)
